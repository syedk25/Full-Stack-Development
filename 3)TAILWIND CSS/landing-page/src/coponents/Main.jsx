...
function Main() {
  return (
    <div className='container mx-auto flex text-center mt-12 p-2 flex-col md:flex-row sm:gap'>
        <div className='md:w-1/3 flex flex-col items-center'>
            <h1 className='text-2xl'>Web Developer</h1>
            <img className='h-40 w-40' src={Web} alt="" />
            <p className='font-sans'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde sint illo omnis veniam numquam soluta impedit ipsum laboriosam voluptatem nemo!</p>
        </div>
        <div className='md:w-1/3 flex flex-col items-center'>
